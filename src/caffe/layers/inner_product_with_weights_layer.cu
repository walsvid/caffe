...
void InnerProductWithWeightsLayer<Dtype>::Forward_gpu(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void InnerProductWithWeightsLayer<Dtype>::Backward_gpu(
...
INSTANTIATE_LAYER_GPU_FUNCS(InnerProductWithWeightsLayer);
